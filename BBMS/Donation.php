                    ...
                    <form action="addDonation.php" method="POST" id="addDonation">
                      <div class="user-details">
                        ...
                        <div class="input-box">
                          ...
                          <input type="text" name="plasma" id="plasma" placeholder="Enter your Staff Id">
                      ...
                      <div class="button" id="add">
                        <button type="submit" name="submitDonation" value="Register">Add Donation </button>
                      </div>
    ...
    <div id="sidebar">
      ...
      <div class="sidebar__link">
        ...
        <div class="sidebar__link">
          ...
          <a href="DonationCampaign.html" style="text-decoration: none;">Donation Campaign</a>
        </div>
