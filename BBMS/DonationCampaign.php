...
<script type="text/javascript" src="js/bootstrap.js"></script>
  ...
  <?php foreach ($camps as $camp) : ?>
      <tr>
        ...
        <td>
                        <button type='button' id='edit' onclick="setDetails('<?php echo $camp['NIC'] ?>')" value='<?php echo $camp['NIC']?>'  class='btn btn-success edit' ><i class="fas fa-user-edit"></i></button></td>
         <td>               
                        <button type="submit" name="updateDonor"  class="btn btn-danger"><i class="fas fa-trash-alt"></i></i></button></td>                
      </tr>
