            ...
            <div>
              <div class="container" style="margin-top: 80px; border: 5px solid #000f2c; border-radius: 25px; background: #ffffff;">
                ...
                <div class="col-sm">
                  ...
                  <h3 style="color:#ffd615; font-weight: bold; font-size: 30px">20</h3>
                </div>
              ...
              <div class="container" style="margin-top: 10px; border: 5px solid #000f2c; border-radius: 25px; background: #ffffff;">
                ...
                <div class="col-sm">
                  ...
                  <?php foreach ($stocks as $stock) : ?>
                    <tr>
                    <td style="color:#ffd615; font-weight: bold; font-size: 20px"><?php echo $stock['BloodGroup'] ?> </td>
                    <td style="color:#ffd615; font-weight: bold; font-size: 20px"><?php echo $stock['total'] ?></td>
                  </tr>
                    <?php endforeach ?>
                  </table>
